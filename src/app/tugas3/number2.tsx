...
export default function Ijo () {
    return (
        ...
        <div className="grid grid-col">
            ...
            <div className="ml-3 max-w-sm w-80 bg-green-500 rounded-lg shadow p-4 mb-4 text-white mt-4">
                ...
                <div className="mt-3">
                    <div className="h-1 bg-green-300 rounded-full">
            ...
            <div className="ml-3 max-w-sm w-80 bg-green-600 rounded-lg shadow p-4 mb-4 text-white mt-4">
                <div className="flex items-center justify-between">
                    <div>
            ...
            <div className="ml-3 max-w-sm w-80 bg-white rounded-lg shadow overflow-hidden mt-4">
                <div className="flex items-center justify-between p-3 border-b">
                    <h2 className="text-sm font-semibold text-gray-700">AUUUOOUUO</h2>
