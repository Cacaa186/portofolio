...
export default function Oren () {
    return (
        ...
        <div className="grid grid-col">
            ...
            <div className="ml-3 max-w-sm w-80 bg-orange-500 rounded-lg shadow p-4 mb-4 text-white mt-4">
            ...
            <div className="ml-3 max-w-sm w-80 bg-orange-600 rounded-lg shadow p-4 mb-5 text-white mt-4">
                <div className="flex items-center justify-between">
                    <div>
            ...
            <div className="ml-3 max-w-sm w-80 bg-white rounded-lg shadow overflow-hidden mt-4">
                <div className="flex items-center justify-between p-3 border-b">
                    <h2 className="text-sm font-semibold text-gray-700">Fens</h2>
