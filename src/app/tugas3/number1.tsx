    ...
    return (
        ...
        <div className="grid grid-col">
            <div className="ml-3 mt-2 max-w-sm w-80 bg-white rounded-lg shadow flex items-center p-4">
                <div className="w-16 h-16 bg-sky-500 rounded flex items-center justify-center">
            ...
            <div className="ml-3 max-w-sm w-80 bg-sky-600 rounded-lg shadow p-4 mb-4 text-white mt-4">
                <div className="flex items-center justify-between">
                    <div>
            ...
            <div className="ml-3 max-w-sm w-80 bg-white rounded-lg shadow overflow-hidden mt-4">
                <div className="flex items-center justify-between p-3 border-b">
                    <h2 className="text-sm font-semibold text-gray-700">Kaliloss</h2>
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div className="flex items-start space-x-2 justify-end">
                        <div>
                            ...
                            <div className="bg-sky-500 text-white px-3 py-2 rounded-lg mt-1 w-50 text-right">
                                GYYXVVXVS huft
                            </div>
                        </div>
                    </div>
